...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    IERC20 constant WBTC = IERC20
    (0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599)
    IERC20 constant USDT = IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7);

    IUniswapV2Factory constant a = IUniswapV2Factory(0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f);
    ...
    constructor() {
        ...
        uniswapV2Pair_WETH_USDT = IUniswapV2Pair(uniswapV2Factory.getPair(address(WETH), address(USDT)));       uniswapV2Pair_WBTC_WETH = IUniswapV2Pair(uniswapV2Factory.getPair(address(WBTC), address(WETH)));
        debt_USDT = 2916378221684;        // END TODO
    }
